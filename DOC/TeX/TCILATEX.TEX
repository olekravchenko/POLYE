...
\typeout{TCILATEX Macros for Scientific Word 2.0 <12 Jan 95>.}
...
%
%
% The following are not defined in LaTeX2e but 
% Scientific Word uses them se we have to define 
% them.
%
